...
namespace PizzariaM1S09.Models
{
    public class PizzariaM1S09Context : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=VICTORIA\\SQLEXPRESS;User ID=sa;Password=Vipr.0411;Database=PizzariaM1S09;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        }
